...
namespace DeckSwipe.Gamestate {
	...
	public class CardStorage {
		...
		private void PopulateFallback() {
			...
			Cards.Add(0, new CardModel.CardModel("This is a test card text that should appear on screen.",
					"Here goes",
					"There goes",
			...
			Cards.Add(1, new CardModel.CardModel("And this is yet another card that you may encounter in the game. Are you having fun thus far?",
					"No",
					"Yes",
					...
					new List<ICardPrerequisite>()));
			Cards.Add(2, new CardModel.CardModel("The hothouse is very cold. The crops are freezing up. What should we do?",
					...
					new List<ICardPrerequisite>()));
			Cards.Add(3, new CardModel.CardModel("The scouts come across what looks to be a wrecked ship. Should they explore it?",
					"No",
					"Yes",
					leadExplorer,
					...
					new CardActionOutcome(0, 0, 0, 0),
					new List<ICardPrerequisite>()));
			Cards.Add(4, new CardModel.CardModel("The scouts find 2 steam cores and a shipment of wood on board the ship. A crew had been trying to survive in the wreck but everybody's dead now.",
					"",
					"",
					leadExplorer,
					...
					new CardActionOutcome(3, 0, 2, 6),
					new List<ICardPrerequisite>()));
			Cards.Add(5, new CardModel.CardModel("The guards bring a woman to you. She yells \"These swine have been pestering me day in day out! How much does it take to tell them to leave me alone?\".",
					...
					new List<ICardPrerequisite>()));
			Cards.Add(6, new CardModel.CardModel("An automaton got stuck in a hothouse. What do we do with it?",
		...
		private void VerifySpecialCards() {
			...
			if (!SpecialCards.ContainsKey("gameover_food")) {
				SpecialCards.Add("gameover_food", new CardModel.CardModel("Hunger consumes the city, as food reserves deplete.", "", "",
						_defaultGameOverCharacter,
						new GameOverCardOutcome(),
						new GameOverCardOutcome(),
						null));
			...
			if (!SpecialCards.ContainsKey("gameover_health")) {
				SpecialCards.Add("gameover_health", new CardModel.CardModel("The city's population succumbs to wounds and spreading diseases.", "", "",
						_defaultGameOverCharacter,
						new GameOverCardOutcome(),
						new GameOverCardOutcome(),
						null));
			...
			if (!SpecialCards.ContainsKey("gameover_hope")) {
				SpecialCards.Add("gameover_hope", new CardModel.CardModel("All hope among the people is lost.", "", "",
						_defaultGameOverCharacter,
						new GameOverCardOutcome(),
						new GameOverCardOutcome(),
						null));
