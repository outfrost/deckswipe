...
public class Game : MonoBehaviour {
	...
	void Start() {
		CardBehaviour cardInstance = Instantiate(CardPrefab, SpawnPosition, Quaternion.identity);
		cardInstance.Card = new CardModel(
				new CardDecisionOutcome(4, 0, -2, -3),
				new CardDecisionOutcome(-1, -1, -1, -1));

		cardInstance = Instantiate(CardPrefab, SpawnPosition, Quaternion.identity);
		cardInstance.Card = new CardModel(
